...
using System.Linq;
using Button = RGR.Views.Shapes.Button;
...
namespace RGR.Models {
    public class main {
        ...
        public IGate[] item_types = Enumerable.Range(0, 8).Select(CreateItem).ToArray();
        ...
        */
        ...
        public void Press(Control item, Point pos) {
            ...
            case 5 or 6 or 7:
                ...
                var gate = GetGate(marker_circle) ?? throw new Exception("main.cs 212");
        ...
        public void ImportScheme(bool start = true) {
            ...
            foreach (var obj in current_scheme.joins) {
                ...
                else { Log.Write("Одно из соединений не того типа: " + obj + " " + auxiliary.Obj2json(obj)); continue; }
                if (join.Length != 6 ||
